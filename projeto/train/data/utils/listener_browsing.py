...
try:
    ...
    # save upload_bytes
    file_upload_bytes = open("../data/browsing_upload_bytes.txt", "a")
    ...
    # save download_bytes
    file_download_bytes = open("../data/browsing_download_bytes.txt", "a")
    ...
    # save upload_ports
    file_upload_ports = open("../data/browsing_upload_ports.txt", "a")
    ...
    # save download_ports
    file_download_ports = open("../data/browsing_download_ports.txt", "a")
