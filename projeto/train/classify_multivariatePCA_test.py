...
from train.classify_multivariatePCA import classify_multivaritePCA
...
if __name__ == '__main__':
    ...
    classify_multivaritePCA(allFeatures, Classes, oClass, yt_test, browsing_test, mining_test, scales)