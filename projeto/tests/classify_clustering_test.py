...
from classifier.utils.classify import extractFeatures, extractFeaturesWavelet, extractFeaturesSilence, \
    breakData, generate_name_from_file
...
if __name__ == '__main__':
    ...
    classify_clustering(unknown_data_features, printing=True, result=generate_name_from_file(file_name))
