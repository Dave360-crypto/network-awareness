...
## -- 1 -- ##
yt = np.loadtxt('download_bytes.txt')
browsing = np.loadtxt('')
mining = np.loadtxt('../dataFiles/Mining.dat')
...
for i in range(nObsTest):
    ...
    print('Obs: {:2}: Normalized Distances to Centroids: [{:.4f},{:.4f},{:.4f}] -> Classification: {} -> {}'.format(i,
                                                                                                                    *ndists,
                                                                                                                    testClass,
                                                                                                                    Classes[
                                                                                                                        testClass]))
...
for i in range(nObsTest):
    ...
    print('Obs: {:2}: Probabilities: [{:.4e},{:.4e},{:.4e}] -> Classification: {} -> {}'.format(i, *probs, testClass,
                                                                                                Classes[testClass]))
